...
#
#   Something is broken here.  In this data set, x = y, yielding a nice
#   clean plot.  Rotating by pi/2 and pi/3 below give IDENTICAL results,
#   the results we should get from pi/2, a perfect "90 degree" rotation
#   of the line.  Using pi/4, however, which should change the plot to a
#   horizontal line (parallel to the x axis), results in plots scattered
#   willy nilly.  Perhaps an overflow problem?
#
